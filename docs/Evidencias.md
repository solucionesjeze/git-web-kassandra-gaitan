...
## Repositorio
**Repositorio:** [solucionesjeze/git-web-kassandra-gaitan](https://github.com/solucionesjeze/git-web-kassandra-gaitan)
...
He confirmado los cambios iniciales con un commit descriptivo y los he enviado al repositorio remoto en GitHub.

![Realizar el primer commit y push](img/PrimerCommit_web.png)


## Crear una nueva rama de trabajo
He creado la rama **feature/header** para desarrollar el encabezado de la página sin afectar la versión principal.

![Crear una nueva rama de trabajo](img/NuevaRama_web.png)
...
He guardado los cambios y los he subido al repositorio remoto.

![Guardar los cambios y subirlos](img/cambios1_web.png)
...
He publicado la versión estable **v1.0.0** del proyecto en la sección **Releases** de GitHub.

![Crear un release en GitHub](img/Release_web.png)
